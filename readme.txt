...
Therefore, most tweets will include images or videos, which makes the display more visually appealing & engaging. 
...
3. Use the Settings -> Ray Twitter Feeds -> Ray Social Feeds For Twitter Settings screen -> In the "Settings" tab, update the "Consumer Key" & "Consumer Secret" with your keys and hit "Save Changes". Read the section below labeled "Generating Twitter API Keys" to know more about how you can generate the API keys.
...
You need to generate a Consumer Key & Consumer Secret for our plugin to fetch & display Tweets on your website.
...
2. This is the screen where you put your API keys & secret.
