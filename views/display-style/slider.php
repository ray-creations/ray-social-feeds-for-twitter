...
foreach( $tweets as $i => $tweet ){
    ...
    $text = Rsfft::rsfft_get_displayable_tweet( $tweet );             //displayable tweet
    $media_html = Rsfft::rsfft_get_media_display_html( $tweet );      //media for tweets
    $tweet_header = Rsfft::rsfft_get_tweet_header( $tweet );        //formatted tweet header part
    $tweet_footer = Rsfft::rsfft_get_tweet_footer($tweet);          //formatted tweet footer part
